...
# -r 表示查找当前目录以及所有子目录
# -l 表示仅列出符合条件的文件名，传给sed命令做替换操作

# 执行以下命令（作用：将“aaa”替换成“bbb”）
grep -rl 'aaa' ./  | xargs sed -i "" "s/aaa/bbb/g"

grep -rl 'http://gitlab.qiyeetech.com/qiyee/qiyee_iOS_code' ./  | xargs sed -i "" "s/http:\\/\\/gitlab.qiyeetech.com\\/qiyee\\/qiyee_iOS_code/http:\\/\\/gitlab.kupu.id\\/iOS/g"

gitlab.qiyeetech.com

grep -rl 'http://gitlab.qiyeetech.com/qiyee/qiyee_iOS_code' ./ | xargs sudo sed -i '' -e "s/http:\\/\\/gitlab.qiyeetech.com\\/qiyee\\/qiyee_iOS_code/http:\\/\\/gitlab.kupu.id\\/iOS/g"

grep -r gitlab.qiyeetech.com|qiyee/qiyee_iOS_code

# 用引号包裹可以解决空格报错：
# sed: .//iOS_Boss_Referral/Example/Pods/Local: No such file or directory
sed -i '' -e "s/http:\\/\\/gitlab.qiyeetech.com\\/qiyee\\/qiyee_iOS_code/http:\\/\\/gitlab.kupu.id\\/iOS/g" "./iOS_Boss_Referral/Example/Pods/Local Podspecs/iOS_Boss_Referral.podspec.json"
...
macOS 12.6                       March 22, 2021                       macOS 12.6
╭─     ~/Desktop                                                                                                                                                                                          15    10161  18:28 
╰─
```
